...
<html>
    <head>
        ...
        for (var x=table.rows.length-1; x>0; x--) {
               ...
               <% ResultSet rs = DBMS.SE("SELECT * FROM `catogary` WHERE `id_catogary`>='15'");
                         while (rs.next()) { %>
  ...
  xhttp.send();  
       ...
       for (var item of array) {
        ...
        table.innerHTML += row;
            ...
            xhttp.open("POST","adminSearch2", true);
      ...
      <div style="width: 1000px; background-color: #000000;padding: 10px;">  
            <nav style="margin-left: 335px;" aria-label="...">
                ...
                <ul class="pagination">
                   ...
                   <a class="page-link" href="main.jsp">Previous</a>
   
                    </li>
 
  <li class="page-item "><a class="page-link" href="main.jsp">1</a></li>
  <li class="page-item active"><a class="page-link" href="main_2.jsp">2</a></li>
