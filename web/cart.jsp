<%-- 
    Document   : cart
    Created on : May 15, 2021, 6:31:19 PM
    Author     : DELL
--%>
  ...
  xhttp.onreadystatechange = function() {
    ...
    document.getElementById('total').innerHTML=tot.toString();
             ...
             var row = `<tr>
                        ...
                        <td style="width: 200px; height: 210px; background-color:white;">`+`<img font-size: 25px; width="200px" height="200px" src="`+"adminImg/"+item.img+`;"/>`+`</div>`+`</td>
                        ...
                        <td style="width: 50px; height: 100px;  text-align: center; border: #ffffff;color: #ffffff; font-size: 25px;">`+item.qty+`</td>
...
function removeItem(index){
  ...
  xhttp.send();  
    ...
    <center>
        ...
        <h1 style="text-align: center; color: #ffffff; ">Yum Bun Yum Cart View</h1><br/>
       

                        <div style="padding: 10px;">     <button onclick="homepage()" class="btn btn-success" style="width: 200px; ">Home Page</button></div> 
                        <div style="padding: 10px;"> <h2 style="color: #ffffff">Total: Rs. </h2>  <h3 id="total" style="width: 400px; color: #ffffff "></h3></div> 

                        <div style="padding: 10px;">     <button onclick="checkout()" class="btn btn-outline-warning" style="width: 400px; ">Check out</button></div> 
...
<table border="0" id="table">
            <thead>
                <tr style="background-color: #ffffff">
                    ...
                    <th style="text-align: center; color: #000000; width: 100px"></th>
                    <th style="text-align: center; color: #000000; font-size: 25px;">*</th>
