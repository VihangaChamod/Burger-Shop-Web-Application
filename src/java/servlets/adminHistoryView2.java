...
@WebServlet(name = "adminHistoryView2", urlPatterns = {"/adminHistoryView2"})
public class adminHistoryView2 extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          HttpSession sea=request.getSession();
            ...
            try {
                  ...
                  ResultSet rs1=DBMS.SE("SELECT * FROM `cart` WHERE `isActive`='"+0+"'");
