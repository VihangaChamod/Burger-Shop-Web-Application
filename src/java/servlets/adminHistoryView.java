...
@WebServlet(name = "adminHistoryView", urlPatterns = {"/adminHistoryView"})
public class adminHistoryView extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          HttpSession sea=request.getSession();
            ...
            try {
                  ...
                  ResultSet rs1=DBMS.SE("SELECT * FROM `cart` WHERE `isActive`='"+1+"'");
