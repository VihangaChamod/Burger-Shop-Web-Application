...
public class DBMS {
    private static final String U="jdbc:mysql://localhost:3306/webfinal";
    private static final String N="root";
    private static final String P="123123";
    private static final String D="com.mysql.cj.jdbc.Driver";
